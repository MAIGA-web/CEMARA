        ...
        <div class="card-body">
            <form action="{{ route('acheter.update', $acheter->id) }}" method="POST">
                ...
                <div class="mt-4">
                    ...
                    {{-- <a href="{{ route('achat.index', ['details' => $acheter->ac_id]) }}" class="btn btn-secondary">Annuler</a> --}}
                     <a href="{{ route('achat.index', ['details' => $acheter->ac_id, 'tab' => 'pills-profile']) }}" class="btn btn-secondary">Retour</a>
                </div>
            </form>
        </div>
    </div>
