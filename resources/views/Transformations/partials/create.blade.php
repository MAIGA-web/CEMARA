...
<div id="right-panel" class="right-panel">
    ...
    <input type="hidden" name="vte_id" value="{{ $vente->id }}">
								<input type="hidden" name="vte_id" value="{{ $vendre->vte_id ?? request()->query('vte_id') }}">
								@csrf
								...
								<div class="form-group ">
									...
									<div class="input-group">
										...
										<input type="number" class="form-control" name="vdr_pu" placeholder="Prix unitaire"
											@if ($vendre['vdr_pu']) value="{{ $vendre['vdr_pu'] }}"
											@else value="{{ old('vdr_pu') }}"
											@endif>
									</div>
								</div>
								<div class="form-group ">
