                ...
                <div class="col-lg-6">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body card-block">
                            <form method="POST" action="{{ $ferme->id ? url('Ferme/update/'.$ferme->id) : url('Ferme/update') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="fer_tel" placeholder="Ex: +223 00 00 00 00"
                                            value="{{ old('fer_tel', $ferme->fer_tel) }}">
                                    </div>
                                </div>
