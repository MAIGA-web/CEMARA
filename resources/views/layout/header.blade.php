@php
    ...
    $fermeId = session('fer_id') ?? (auth()->user()->fer_id ?? null);

    $fermeActive = $fermeId ? Ferme::find($fermeId) : Ferme::first();
@endphp
<!doctype html>
...
<head>
    ...
    <!-- Token CSRF pour la sécurité Laravel -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>CƐMARA - {{ $fermeActive->fer_nom ?? 'Gestion Avicole' }}</title>
    
    <!-- Méta-données de l'application -->
    <meta name="description" content="CƐMARA - Plateforme de gestion avicole et de suivi de ferme.">
    <meta name="author" content="CƐMARA">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true"
                            ...
                            @if (!empty($fermeActive) && $fermeActive->fer_logo)
                                <img src="{{ public_path('storage/' . $fermeActive->fer_logo) }}"
